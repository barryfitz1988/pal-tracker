...
public class EnvController {
    ...
    public EnvController(
            @Value("${cf.instance.port:NOT SET}")  String PORT,
            @Value("${cf.instance.memory.limit:NOT SET}") String MEMORY_LIMIT,
            @Value("${cf.instance.index:NOT SET}") String CF_INSTANCE_INDEX,
            @Value("${cf.instance.address:NOT SET}") String CF_INSTANCE_ADDR) {
        this.PORT = PORT;
